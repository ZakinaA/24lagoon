...
public class FormSurgrade {
    ...
    private void validationLibelle( String libelle ) throws Exception {
        ...
        throw new Exception( "Le surgrade doit contenir au moins 3 caractères." );
        }
    }
    ...
    public Surgrade ajouterSurgrade( HttpServletRequest request ) {
